        ...
        foreach my $attr (@{$attributes->{attribute}})
        {
            ...
            if($attr->{id} eq $inname) {
                ...
                foreach my $target (@targets)
                {
                    ...
                    } elsif ($target eq "TARGET_TYPE_GI2C") {
...
print OCMBFILE "// This file is generated by perl script ppeParseProcSbeFixed.pl\n\n";
...
foreach my $attr (@attrOcmbChipIds)
{
    ...
    {
        print OCMBFILE "PROC_SBE_FIXED_$value\_VECTOR($attr->{id}, $attr->{array});\n"
    }
...
print PMICFILE "// This file is generated by perl script ppeParseProcSbeFixed.pl\n\n";
...
foreach my $attr (@attrPMICIds)
{
    ...
    my $value = uc $attr->{valueType};
    print PMICFILE "PROC_SBE_FIXED_TARGET_$value($attr->{id}, PMIC_TARGET_COUNT);\n"
...
print GI2CFILE "// This file is generated by perl script ppeParseProcSbeFixed.pl\n\n";
...
foreach my $attr (@attrGI2CIds)
{
    ...
    my $value = uc $attr->{valueType};
    print GI2CFILE "PROC_SBE_FIXED_TARGET_$value($attr->{id}, GI2C_TARGET_COUNT);\n"
