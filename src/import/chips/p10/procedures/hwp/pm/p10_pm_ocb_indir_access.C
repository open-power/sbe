    ...
    uint64_t*                     io_ocb_buffer)
{
    ...
    switch ( i_ocb_chan )
    {
        case ocb::OCB_CHAN0:
            ...
            l_OCBSLBR_address = TP_TPCHIP_OCC_OCI_OCB_OCBSLBR0_RW;
            l_OCBSLCS_address = TP_TPCHIP_OCC_OCI_OCB_OCBSLCS0_SCOM;
            l_OCBSHBR_address = TP_TPCHIP_OCC_OCI_OCB_OCBSHBR0_RW;
            l_OCBSHCS_address = TP_TPCHIP_OCC_OCI_OCB_OCBSHCS0_SCOM;
            l_OCBSES_address  = TP_TPCHIP_OCC_OCI_OCB_OCBSES0_RW;
            l_OCBLWCR_address = TP_TPCHIP_OCC_OCI_OCB_OCBLWCR0_RW;
            l_OCBLWSR_address = TP_TPCHIP_OCC_OCI_OCB_OCBLWSR0_RO;
        ...
        case ocb::OCB_CHAN1:
            ...
            l_OCBCSR_address  = TP_TPCHIP_OCC_OCI_OCB_PIB_OCBCSR3_RO;
            l_OCBSLBR_address = TP_TPCHIP_OCC_OCI_OCB_OCBSLBR1_RW;
            l_OCBSLCS_address = TP_TPCHIP_OCC_OCI_OCB_OCBSLCS1_SCOM;
            l_OCBSHBR_address = TP_TPCHIP_OCC_OCI_OCB_OCBSHBR1_RW;
            l_OCBSHCS_address = TP_TPCHIP_OCC_OCI_OCB_OCBSHCS1_SCOM;
            l_OCBSES_address  = TP_TPCHIP_OCC_OCI_OCB_OCBSES1_RW;
            l_OCBLWCR_address = TP_TPCHIP_OCC_OCI_OCB_OCBLWCR1_RW;
            l_OCBLWSR_address = TP_TPCHIP_OCC_OCI_OCB_OCBLWSR1_RO;
        ...
        case ocb::OCB_CHAN2:
            ...
            l_OCBCSR_address  = TP_TPCHIP_OCC_OCI_OCB_PIB_OCBCSR3_RO;
            l_OCBSLBR_address = TP_TPCHIP_OCC_OCI_OCB_OCBSLBR2_RW;
            l_OCBSLCS_address = TP_TPCHIP_OCC_OCI_OCB_OCBSLCS2_SCOM;
            l_OCBSHBR_address = TP_TPCHIP_OCC_OCI_OCB_OCBSHBR2_RW;
            l_OCBSHCS_address = TP_TPCHIP_OCC_OCI_OCB_OCBSHCS2_SCOM;
            l_OCBSES_address  = TP_TPCHIP_OCC_OCI_OCB_OCBSES2_RW;
            l_OCBLWCR_address = TP_TPCHIP_OCC_OCI_OCB_OCBLWCR2_RW;
            l_OCBLWSR_address = TP_TPCHIP_OCC_OCI_OCB_OCBLWSR2_RO;
        ...
        case ocb::OCB_CHAN3:
            ...
            l_OCBCSR_address  = TP_TPCHIP_OCC_OCI_OCB_PIB_OCBCSR3_RO;
            l_OCBSLBR_address = TP_TPCHIP_OCC_OCI_OCB_OCBSLBR3_RW;
            l_OCBSLCS_address = TP_TPCHIP_OCC_OCI_OCB_OCBSLCS3_SCOM;
            l_OCBSHBR_address = TP_TPCHIP_OCC_OCI_OCB_OCBSHBR3_RW;
            l_OCBSHCS_address = TP_TPCHIP_OCC_OCI_OCB_OCBSHCS3_SCOM;
            l_OCBSES_address  = TP_TPCHIP_OCC_OCI_OCB_OCBSES3_RW;
            l_OCBLWCR_address = TP_TPCHIP_OCC_OCI_OCB_OCBLWCR3_RW;
            l_OCBLWSR_address = TP_TPCHIP_OCC_OCI_OCB_OCBLWSR3_RO;
