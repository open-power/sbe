    ...
    const fapi2::Target<fapi2::TARGET_TYPE_PROC_CHIP>& i_target)
{
    ...
    FAPI_TRY(fapi2::getScom(i_target, 0x00000004ull, l_data));
    FAPI_TRY(fapi2::putScom(i_target, 0x00000004ull, l_data));

    l_data.flush<0>();
    FAPI_TRY(fapi2::putScom(i_target, 0x00000024ull, l_data));

    FAPI_TRY(fapi2::getScom(i_target, 0x00000014ull, l_data));
    ...
    FAPI_TRY(fapi2::getScom(i_target, 0x00030013ull, l_data));
    l_data.setBit<0>();
    l_data.setBit<1>();
    l_data.setBit<2>();
    l_data.setBit<3>();
    ...
    l_data.setBit<41>();
    l_data.setBit<42>();
    l_data.insertFromRight<43, 3>(0xFull);
    l_data.setBit<46>();
    l_data.setBit<47>();
    l_data.setBit<48>();
    l_data.setBit<49>();
    ...
    l_data.insertFromRight<0, 49>(0xFull);
    ...
    FAPI_TRY(fapi2::getScom(i_target, 0x00040017ull, l_data));
    l_data.insertFromRight<0, 5>(0xFull);
    ...
    FAPI_TRY(fapi2::getScom(i_target, 0x0005000full, l_data));
    l_data.setBit<0>();
    l_data.setBit<1>();
    ...
    FAPI_TRY(fapi2::getScom(i_target, 0x0003000full, l_data));
    l_data.setBit<0>();
    l_data.setBit<1>();
    l_data.setBit<2>();
    l_data.setBit<3>();
    ...
    l_data.setBit<5>();
    l_data.setBit<6>();
    l_data.insertFromRight<7, 19>(0xFull);
    l_data.setBit<8>();
    l_data.setBit<9>();
    l_data.setBit<10>();
    l_data.setBit<11>();
    l_data.setBit<12>();
    l_data.setBit<13>();
    l_data.insertFromRight<14, 12>(0xFull);
    l_data.insertFromRight<15, 11>(0xFull);
    l_data.setBit<16>();
    l_data.setBit<17>();
    l_data.setBit<18>();
    l_data.setBit<19>();
    l_data.setBit<20>();
    l_data.insertFromRight<21, 5>(0xFull);
    l_data.setBit<26>();
    l_data.insertFromRight<27, 32>(0xFull);
    FAPI_TRY(fapi2::putScom(i_target, 0x00040002ull, l_data));

    FAPI_TRY(fapi2::getScom(i_target, 0x000f0005ull, l_data));
    FAPI_TRY(fapi2::putScom(i_target, 0x000f0005ull, l_data));

    l_data.flush<0>();
    FAPI_TRY(fapi2::putScom(i_target, 0x000f0006ull, l_data));

    FAPI_TRY(fapi2::getScom(i_target, 0x000f0007ull, l_data));
    FAPI_TRY(fapi2::putScom(i_target, 0x000f0007ull, l_data));
    ...
    l_data.insertFromRight<0, 22>(0xFull);
    ...
    l_data.setBit<13>();
    l_data.setBit<14>();
    l_data.insertFromRight<15, 6>(0xFull);
    ...
    l_data.setBit<48>();
    l_data.setBit<49>();
    l_data.insertFromRight<50, 2>(0xFull);
    l_data.setBit<52>();
    l_data.setBit<53>();
    l_data.setBit<54>();
    ...
    FAPI_TRY(fapi2::getScom(i_target, 0x00030004ull, l_data));
    l_data.setBit<0>();
    l_data.insertFromRight<1, 3>(0xFull);
    ...
    l_data.setBit<40>();
    l_data.insertFromRight<41, 7>(0xFull);
    l_data.insertFromRight<48, 16>(0xFull);
    ...
    FAPI_TRY(fapi2::getScom(i_target, 0x000f001bull, l_data));
    ...
    l_data.setBit<3>();
    l_data.setBit<4>();
    l_data.insertFromRight<5, 19>(0xFull);
    l_data.setBit<6>();
    l_data.setBit<7>();
    l_data.setBit<8>();
    l_data.setBit<9>();
    ...
    FAPI_TRY(fapi2::getScom(i_target, 0x00039000ull, l_data));
    ...
    l_data.flush<0>();
    l_data.insertFromRight<0, 10>(0xFull);
    ...
    l_data.setBit<11>();
    l_data.setBit<12>();
    l_data.insertFromRight<13, 2>(0xFull);
    l_data.setBit<15>();
    l_data.insertFromRight<16, 8>(0xFull);
    ...
    l_data.setBit<20>();
    l_data.setBit<21>();
    l_data.insertFromRight<22, 6>(0xFull);
    ...
    FAPI_TRY(fapi2::getScom(i_target, 0x000104c2ull, l_data));
    l_data.setBit<0>();
    l_data.setBit<1>();
    l_data.insertFromRight<2, 8>(0xFull);
    l_data.setBit<10>();
    ...
    FAPI_TRY(fapi2::getScom(i_target, 0x00010500ull, l_data));
    l_data.insertFromRight<0, 64>(0xFull);
    ...
    FAPI_TRY(fapi2::getScom(i_target, 0x00010506ull, l_data));
    l_data.insertFromRight<0, 24>(0xFull);
    l_data.insertFromRight<24, 24>(0xFull);
    ...
    FAPI_TRY(fapi2::getScom(i_target, 0x000105c0ull, l_data));
    l_data.insertFromRight<0, 64>(0xFull);
    ...
    FAPI_TRY(fapi2::getScom(i_target, 0x000105c8ull, l_data));
    l_data.insertFromRight<0, 24>(0xFull);
    l_data.insertFromRight<24, 24>(0xFull);
    ...
    FAPI_TRY(fapi2::getScom(i_target, 0x00010704ull, l_data));
    l_data.insertFromRight<0, 24>(0xFull);
    ...
    FAPI_TRY(fapi2::getScom(i_target, 0x00010706ull, l_data));
    l_data.insertFromRight<0, 24>(0xFull);
    l_data.insertFromRight<24, 24>(0xFull);
