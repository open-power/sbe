...
def main( ):
    ...
    testUtil.writeUsFifo( INST_INVALID_TESTDATA, i_fifoType )
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_INVALID_EXPDATA_ERR, i_fifoType )
    testUtil.readEot(i_fifoType)

    # Control Instruction Message - Stop
    testUtil.writeUsFifo( INST_STOP_0_0_TESTDATA_WITH_WARN_FLG, i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType)
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_STOP_0_1_TESTDATA_WITH_WARN_FLG, i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType)
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_STOP_0_2_TESTDATA_WITH_WARN_FLG, i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType )
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_STOP_0_3_TESTDATA_WITH_WARN_FLG, i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType)
    testUtil.readEot( i_fifoType )
    testUtil.writeUsFifo( INST_STOP_0_0_TESTDATA_WITHOUT_WARN_FLG, i_fifoType )
    testUtil.writeEot( i_fifoType )
    testUtil.readDsFifo( STOP_INST_EXPDATA_ERR_WTH_FFDC, i_fifoType )
    testUtil.extractHWPFFDC(i_fifoType)
    #flush out distance
    testUtil.readDsEntryReturnVal(i_fifoType)
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_STOP_0_1_TESTDATA_WITHOUT_WARN_FLG, i_fifoType )
    testUtil.writeEot(i_fifoType )
    testUtil.readDsFifo( STOP_INST_EXPDATA_ERR_WTH_FFDC, i_fifoType )
    testUtil.extractHWPFFDC(i_fifoType)
    #flush out distance
    testUtil.readDsEntryReturnVal(i_fifoType)
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_STOP_0_2_TESTDATA_WITHOUT_WARN_FLG, i_fifoType )
    testUtil.writeEot(i_fifoType )
    testUtil.readDsFifo( STOP_INST_EXPDATA_ERR_WTH_FFDC, i_fifoType )
    testUtil.extractHWPFFDC(i_fifoType)
    #flush out distance
    testUtil.readDsEntryReturnVal(i_fifoType)
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_STOP_0_3_TESTDATA_WITHOUT_WARN_FLG, i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( STOP_INST_EXPDATA_ERR_WTH_FFDC, i_fifoType)
    testUtil.extractHWPFFDC(i_fifoType)
    #flush out distance
    ...
    testUtil.writeUsFifo( INST_STOP0_ALL_TESTDATA_WITH_WARN_FLG, i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType)
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_STOP0_ALL_TESTDATA_WITHOUT_WARN_FLG, i_fifoType)
    testUtil.writeEot(i_fifoType )
    testUtil.readDsFifo( STOP_INST_EXPDATA_ERR_WTH_FFDC, i_fifoType )
    testUtil.extractHWPFFDC(i_fifoType)
    #flush out distance
    ...
    testUtil.writeUsFifo( INST_START_0_0_TESTDATA_WITH_WARN_FLG, i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType )
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_START_0_1_TESTDATA_WITH_WARN_FLG, i_fifoType )
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType )
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_START_0_2_TESTDATA_WITH_WARN_FLG, i_fifoType )
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType )
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_START_0_3_TESTDATA_WITH_WARN_FLG, i_fifoType )
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType )
    testUtil.readEot(i_fifoType)

    testUtil.writeUsFifo( INST_START_0_0_TESTDATA_WITHOUT_WARN_FLG, i_fifoType )
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( START_IiNST_EXPDATA_ERR_WTH_FFDC,i_fifoType )
    testUtil.extractHWPFFDC(i_fifoType)
    #flush out distance
    testUtil.readDsEntryReturnVal(i_fifoType)
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_START_0_1_TESTDATA_WITHOUT_WARN_FLG, i_fifoType )
    testUtil.writeEot(i_fifoType )
    testUtil.readDsFifo( START_INST_EXPDATA_ERR_WTH_FFDC, i_fifoType )
    testUtil.extractHWPFFDC(i_fifoType )
    #flush out distance
    testUtil.readDsEntryReturnVal(i_fifoType)
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_START_0_2_TESTDATA_WITHOUT_WARN_FLG, i_fifoType )
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( START_INST_EXPDATA_ERR_WTH_FFDC, i_fifoType )
    testUtil.extractHWPFFDC(i_fifoType)
    #flush out distance
    testUtil.readDsEntryReturnVal(i_fifoType)
    testUtil.readEot(i_fifoType )
    testUtil.writeUsFifo( INST_START_0_3_TESTDATA_WITHOUT_WARN_FLG, i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( START_INST_EXPDATA_ERR_WTH_FFDC, i_fifoType)
    testUtil.extractHWPFFDC(i_fifoType)
    #flush out distance
    ...
    testUtil.writeUsFifo( INST_START0_ALL_TESTDATA_WITH_WARN_FLG, i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType)
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_START0_ALL_TESTDATA_WITHOUT_WARN_FLG, i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( START_INST_EXPDATA_ERR_WTH_FFDC, i_fifoType)
    testUtil.extractHWPFFDC(i_fifoType)
    #flush out distance
    ...
    testUtil.writeUsFifo( INST_STEP_0_0_TESTDATA_WITH_WARN_FLG, i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType )
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_STEP_0_1_TESTDATA_WITH_WARN_FLG, i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType )
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_STEP_0_2_TESTDATA_WITH_WARN_FLG, i_fifoType )
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType )
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_STEP_0_3_TESTDATA_WITH_WARN_FLG, i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType)
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_STEP_0_0_TESTDATA_WITHOUT_WARN_FLG, i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( STEP_INST_EXPDATA_ERR_WTH_FFDC, i_fifoType)
    testUtil.extractHWPFFDC(i_fifoType)
    #flush out distance
    testUtil.readDsEntryReturnVal(i_fifoType)
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_STEP_0_1_TESTDATA_WITHOUT_WARN_FLG, i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( STEP_INST_EXPDATA_ERR_WTH_FFDC, i_fifoType)
    testUtil.extractHWPFFDC(i_fifoType)
    #flush out distance
    testUtil.readDsEntryReturnVal(i_fifoType)
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_STEP_0_2_TESTDATA_WITHOUT_WARN_FLG,i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( STEP_INST_EXPDATA_ERR_WTH_FFDC, i_fifoType)
    testUtil.extractHWPFFDC(i_fifoType)
    #flush out distance
    testUtil.readDsEntryReturnVal(i_fifoType)
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_STEP_0_3_TESTDATA_WITHOUT_WARN_FLG, i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( STEP_INST_EXPDATA_ERR_WTH_FFDC, i_fifoType)
    testUtil.extractHWPFFDC(i_fifoType)
    #flush out distance
    ...
    testUtil.writeUsFifo( INST_STEP0_ALL_TESTDATA_WITH_WARN_FLG,i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType)
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_STEP0_ALL_TESTDATA_WITHOUT_WARN_FLG, i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( STEP_INST_EXPDATA_ERR_WTH_FFDC, i_fifoType)
    testUtil.extractHWPFFDC(i_fifoType)
    #flush out distance
    ...
    testUtil.writeUsFifo( INST_SRESET_0_0_TESTDATA_WITH_WARN_FLG, i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType)
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_SRESET_0_1_TESTDATA_WITH_WARN_FLG, i_fifoType)
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType)
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_SRESET_0_2_TESTDATA_WITH_WARN_FLG, i_fifoType )
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType )
    testUtil.readEot( i_fifoType)
    testUtil.writeUsFifo( INST_SRESET_0_3_TESTDATA_WITH_WARN_FLG, i_fifoType )
    testUtil.writeEot( i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType )
    testUtil.readEot( i_fifoType)
    testUtil.writeUsFifo( INST_SRESET_0_0_TESTDATA_WITHOUT_WARN_FLG, i_fifoType )
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType )
    testUtil.readEot(i_fifoType)
    testUtil.writeUsFifo( INST_SRESET_0_1_TESTDATA_WITHOUT_WARN_FLG,i_fifoType )
    testUtil.writeEot(i_fifoType )
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType )
    testUtil.readEot( i_fifoType)
    testUtil.writeUsFifo( INST_SRESET_0_2_TESTDATA_WITHOUT_WARN_FLG, i_fifoType )
    testUtil.writeEot(i_fifoType )
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType )
    testUtil.readEot(i_fifoType )
    testUtil.writeUsFifo( INST_SRESET_0_3_TESTDATA_WITHOUT_WARN_FLG, i_fifoType )
    testUtil.writeEot(i_fifoType )
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType )
    testUtil.readEot(i_fifoType)

    #step all thread in core0
    testUtil.writeUsFifo( INST_SRESET0_ALL_TESTDATA_WITH_WARN_FLG, i_fifoType )
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType )
    testUtil.readEot(i_fifoType )
    testUtil.writeUsFifo( INST_SRESET0_ALL_TESTDATA_WITHOUT_WARN_FLG, i_fifoType )
    testUtil.writeEot(i_fifoType)
    testUtil.readDsFifo( INST_EXPDATA, i_fifoType )
    testUtil.readEot(i_fifoType)
