...
#-------------------------------------------------
def main( ):
    # To trigger HReset using 50008 bit 13 (Legacy - No more supported from 1030 release)
    # To trigger HReset using 50008 bit 15 (Alternative to HRESET is S1 interrupt)
    ...
    print("Trigger HReset via S1 interrupt ")
    cmd_write = simicsObj[0] + ".cfam_cmp.lbus_map.write 0x2820 0x00010000 -b 4"
