...
def exportFiles(sbe_simdata_dir, img_dir):
    ...
    os.system('cp '+img_dir+'/../src/tools/debug/simics-debug-framework.py'+' '+sbe_simdata_dir+'/')
    os.system('cp '+img_dir+'/../src/tools/debug/sbe-debug.py'+' '+sbe_simdata_dir+'/')
    os.system('cp '+img_dir+'/../src/tools/debug/simics/sbe_startup_p10_standalone.simics'+' '+sbe_simdata_dir+'/')
