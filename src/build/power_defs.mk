...
VERIF_HWP_SRCDIR = $(IMPORT_HWP_MK_DIR)/verif_hwp
...
OBJDIR-VERIF-HWP = $(BASE_OBJDIR)/$(IMPORT_OBJDIR)/verif_hwp
...
VERIFICATION_PROJ_SUBDIRS := $(VERIF_HWP_SRCDIR)
VERIFICATION_PROJ_LIB_DIRS += -L$(OBJDIR-VERIF-HWP)
VERIFICATION_PROJ_LLIBS += -lverif_hwp
