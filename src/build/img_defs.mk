...
ifndef IMG_INCLUDES
export IMG_INCLUDES = -I$(IMAGEPROCS_COMMON_SRCDIR) -I$(IMAGEPROCS_P9_SRCDIR) -I$(IMAGEPROCS_P10_SRCDIR) -I$(IMAGEPROCS_CEN_SRCDIR) -I$(IMAGEPROCS_TOOL_DIR) -I$(BUILD_DIR) -I$(CACHE_SRCDIR) -I$(CORE_SRCDIR) -I$(PERV_SRCDIR) -I$(P9_PERV_SRCDIR) -I$(NEST_SRCDIR) -I$(P9_NEST_SRCDIR) -I$(IO_SRCDIR) -I$(PM_SRCDIR) -I$(INITFILES_SRCDIR) -I$(HWPLIB_SRCDIR) -I$(P9_HWPLIB_SRCDIR) -I$(HWPFFDC_SRCDIR) -I$(MEMHWP_SRCDIR) -I$(IMAGEPROCS_COMMON_SCOM_SRCDIR) -I$(IMAGEPROCS_COMMON_INCDIR)
endif
