...
ifndef SECUREBOOT_COMMON_SRCDIR
export SECUREBOOT_COMMON_SRCDIR = $(SBE_SRC_DIR)/sbefw/securebootcommon
endif

ifndef VERIFICATION_SRCDIR
export VERIFICATION_SRCDIR = $(SBE_SRC_DIR)/sbefw/verification
endif
...
ifndef UTILS_SRCDIR
export UTILS_SRCDIR = $(IMPORT_SRCDIR)/chips/p10/utils
endif
...
ifndef SPI_SRCDIR
export SPI_SRCDIR = $(IMPORT_SRCDIR)/chips/p10/procedures/hwp/spi
endif

ifndef MEMORY_SRCDIR
export MEMORY_SRCDIR = $(IMPORT_SRCDIR)/chips/p10/procedures/hwp/memory
endif
...
ifndef IMAGEPROCS_COMMON_SCOMINFODIR
export IMAGEPROCS_COMMON_SCOMINFODIR = $(IMPORT_SRCDIR)/chips/p10/common/scominfo/
endif
...
ifndef GENERR_SRCDIR
export GENERR_SRCDIR = $(IMPORT_SRCDIR)/generic/procedures/xml/error_info
endif

ifndef OCMBERR_SRCDIR
export OCMBERR_SRCDIR = $(IMPORT_SRCDIR)/chips/ocmb/explorer/procedures/xml/error_info
endif

ifndef I2CHWP_SRCDIR
export I2CHWP_SRCDIR = $(IMPORT_SRCDIR)/chips/ocmb/explorer/procedures/hwp/memory/lib/i2c
endif

ifndef OCMBSHR_SRCDIR
export OCMBSHR_SRCDIR = $(IMPORT_SRCDIR)/chips/ocmb/explorer/procedures/hwp/memory/lib/shared
endif

ifndef PMIC_SRCDIR
export PMIC_SRCDIR = $(IMPORT_SRCDIR)/chips/ocmb/common/procedures/hwp/pmic
endif

ifndef PMIC_INCDIR
export PMIC_INCDIR = $(IMPORT_SRCDIR)/chips/ocmb/common/include
endif

ifndef GENUTL_SRCDIR
export GENUTL_SRCDIR = $(IMPORT_SRCDIR)/generic/memory/lib/utils
endif

ifndef GENSHR_SRCDIR
export GENSHR_SRCDIR = $(IMPORT_SRCDIR)/generic/memory/lib/utils/shared
endif

ifndef P10_SBE_DEBUG_TOOL
export P10_SBE_DEBUG_TOOL = $(SBE_SRC_DIR)/tools/debug/sbe-debug.py
endif

ifndef MEAS_IMAGE_DIR
export MEAS_IMAGE_DIR = $(BUILD_DIR)/measurement_image
endif

ifndef VERF_IMAGE_DIR
export VERF_IMAGE_DIR = $(BUILD_DIR)/verification_image
endif

ifndef IMG_INCLUDES
export IMG_INCLUDES = -I$(IMAGEPROCS_COMMON_SRCDIR) -I$(IMAGEPROCS_P9_SRCDIR) -I$(IMAGEPROCS_P10_SRCDIR) -I$(IMAGEPROCS_CEN_SRCDIR) -I$(IMAGEPROCS_TOOL_DIR) -I$(BUILD_DIR) -I$(CACHE_SRCDIR) -I$(CORE_SRCDIR) -I$(PERV_SRCDIR) -I$(NEST_SRCDIR) -I$(P9_NEST_SRCDIR) -I$(IO_SRCDIR) -I$(PM_SRCDIR) -I$(INITFILES_SRCDIR) -I$(HWPLIB_SRCDIR) -I$(P9_HWPLIB_SRCDIR) -I$(HWPFFDC_SRCDIR) -I$(MEMHWP_SRCDIR) -I$(IMAGEPROCS_COMMON_SCOM_SRCDIR) -I$(IMAGEPROCS_COMMON_INCDIR) -I$(CORECACHE_SRCDIR) -I$(UTILS_SRCDIR) -I$(SPI_SRCDIR) -I$(I2CHWP_SRCDIR) -I$(GENUTL_SRCDIR) -I$(GENSHR_SRCDIR) -I$(OCMBSHR_SRCDIR) -I$(IMAGEPROCS_COMMON_SCOMINFODIR) -I$(MEMORY_SRCDIR) -I$(SECUREBOOT_COMMON_SRCDIR) -I$(VERIFICATION_SRCDIR) -I$(PMIC_SRCDIR) -I$(PMIC_INCDIR)
endif
...
export IMPORT_UTILS_DIR = $(IMPORT_SRCDIR)/chips/p10/utils
endif
...
#GCC-DEFS += -DEQ_CLOCK_STAT_DISABLE
#GCC-DEFS += -DEQ_SKEW_ADJUST_DISABLE
#GCC-DEFS += -DP10_HCD_CORECACHE_SKIP_INITF
#GCC-DEFS += -DP10_HCD_CORECACHE_SKIP_ARRAY
#GCC-DEFS += -DP10_HCD_CORECACHE_SKIP_FLUSH
endif
...
# Use for dilithium algorithim
ifeq ($(VERIFICATION_IMAGE_SUPPORTED), 1)
GCC-DEFS += -DNO_CRYSTALS_CIP
GCC-DEFS += -DNO_CRYSTALS_KEX
GCC-DEFS += -DNO_DILITHIUM_SIGN
GCC-DEFS += -DNO_MLDSA_SIGN
GCC-DEFS += -DNO_DILITHIUM_VERIFY
GCC-DEFS += -DUSE_DYNAMIC_ALLOC
endif
...
GCC-DEFS += -DSBEV_TRACE_LEVEL=$(SBEV_TRACE_LEVEL_DEF)
